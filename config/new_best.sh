...
# NEW BEST MCE-3 
python train.py --name MCE-3_lcom_w_wd --experts 3 --log_wandb True --L2penalty True --large_dataset True --aggregation mean --out_dir out/ablation/ --weight_decay 0.2 --epoch 50 --catchup_training True

## run test max logits 
#python train.py --name mce_lcom_ws13 --expert 3 --log_wandb True --L2penalty True --test_only True  --out_dir out/best/  
