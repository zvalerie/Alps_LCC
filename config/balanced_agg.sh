...
python train.py --experts 3 --aggregation MLP_select   --epoch 50   --lr 0.00001  --name MLP_select_CBL_lr_1e-5   --log_wandb True   --weight_decay 0.2    --lws True   --finetune_classifier_only True  --pretrained_weights /home/valerie/Projects/Alps_LCC/out/august/MCE3_moptim/current_best.pt 

python train.py --experts 3 --aggregation CNN_select   --epoch 50   --lr 0.00001  --name CNN_select_CBL_lr_1e-5   --log_wandb True   --weight_decay 0.2    --lws True   --finetune_classifier_only True  --pretrained_weights /home/valerie/Projects/Alps_LCC/out/august/MCE3_moptim/current_best.pt 
