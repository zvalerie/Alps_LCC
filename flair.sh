...
## MCE 2
python train.py --name MCE2_dev  --experts 2   --lws False --L2penalty True     --debug True   --log_wand True

## MCE 3 
python train.py --name MCE3_dev --experts 3   --lws False --L2penalty True    --debug True   --log_wand True
