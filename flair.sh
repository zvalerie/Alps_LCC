...
# weighted CE
python train.py --name WCEL_dev   --experts 0    --loss inverse_freq_weights --debug True   --log_wand True

# Class balanced loss : 
python train.py --name CBL_dev   --experts 0    --loss cbloss --debug True   --log_wand True
...
#simple CE 
python train.py --name CEL_base  --experts 0  --loss celoss    --large_dataset True  --log_wand True

# weighted CE
python train.py --name WEL_base   --experts 0    --loss inverse_freq_weights --large_dataset True  --log_wand True
...
## MCE 2
python train.py --name MCE2_base  --experts 2   --lws True --L2penalty True --weight_decay 0.2    --large_dataset True  --log_wand True

## MCE 3 
python train.py --name MCE3_base --experts 3   --lws True --L2penalty True --weight_decay 0.2   --large_dataset True  --log_wand True
