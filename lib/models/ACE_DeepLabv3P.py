...
class DeepLabHeadV3Plus(nn.Module):
    def __init__(self, in_channels, low_level_channels, num_classes, num_experts, aspp_dilate=[12, 24, 36]):
...
def deeplabv3P_resnet(num_classes, output_stride, pretrained_backbone, num_experts):
    ...
    classifier = DeepLabHeadV3Plus(inplanes, low_level_planes, num_classes, num_experts, aspp_dilate)
